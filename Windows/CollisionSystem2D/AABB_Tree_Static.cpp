...
void CollisionSystem2D::AABB_Tree_Static::createNewBox(ID id, float centerX, float centerY, float colliderWidth, float colliderHeight)
{
	Point2D min, max;

	float halfWidth = colliderWidth / 2;
